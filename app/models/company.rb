...
class Company < ActiveRecord::Base
  ...
  accepts_nested_attributes_for :affiliations, :associations, :certifications, :locations, :business_license,
                                :personal_license, :business_filing

  attr_accessible :admin_email, :name, :email, :phone_main, :phone_mobile, :phone_fax, :website_url, :in_business_since,
                  :about, :description, :general_info, :offers_24_hour_service, :offers_emergency_service, :insured,
                  :insurance_state_id, :insurance_certificate, :insurance_valid_from, :insurance_valid_until
  # also make sure all the nested attributes are accessible
  attr_accessible :affiliations_attributes, :associations_attributes, :certifications_attributes, :locations_attributes,
                  :business_license_attributes, :personal_license_attributes, :business_filing_attributes
