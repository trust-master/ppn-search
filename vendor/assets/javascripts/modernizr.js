 ...
 * Build: http://www.modernizr.com/download/#-backgroundsize-borderimage-borderradius-boxshadow-hsla-multiplebgs-opacity-rgba-textshadow-cssanimations-generatedcontent-hashchange-history-input-inputtypes-shiv-cssclasses-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-load
 */
;
        ...
        injectElementWithStyles(style, function( node, rule ) {
            ...
            while ( len-- ) {
                hash[children[len].id] = children[len];
                            ...
                            Modernizr['generatedcontent'] = (hash['generatedcontent'] && hash['generatedcontent'].offsetHeight) >= 1;                   }, len, tests);
